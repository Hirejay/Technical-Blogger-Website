...
<html>
    ...
    <body>
            ...
            <div class="container-fluid ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link "  href="#"><i class="bi bi-person-check icon-margin"></i>Profile</a>
                        </li>
                ...
                <div class="row mt-3">
                    <div class="col-md-2 p-2">
                        <div class="list-group" style=" position: sticky; top: 20px">
                            <a href="#" onclick="getposts(0);" class="list-group-item list-group-item-action primary-color " aria-current="true">
                                All Categories
                            </a>
                            <%  Postdao cpd = new Postdao(ConnectionProvider.getConnection());
                                ArrayList<Categories> clist = cpd.getAllCategories();
                    ...
                    <div class="col-md-10" >
                        ...
                        <div class="container text-center" id="loader">
                            <i class="fa fa-refresh fa-4x fa-spin"></i><!-- comment -->
                            <h3 class="mt-2" >Loading...... </h3>
                        </div>
                        <div class="container-fluid" id="post-container">
                            <!--post are loading there-->
                        </div>
        ...
        <!--        post list on left side active color-->
        <script>
            $(document).ready(function () {
                $("div.list-group > a").click(function (e) {
                    $("div.list-group > a").removeClass("primary-color text-white");
                    $(this).addClass("primary-color text-white");
                });
            });
        </script>


        <!--      end  post list on left side active color-->

        <!--start loading post using ajax-->
